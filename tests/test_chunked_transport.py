...
class ChunkedTransportTestCase(TestCase):
...
if CYTHON:
    from thriftpy2.transport.chunked import TCyChunkedTransportFactory
    from thriftpy2.protocol.cybin import TCyBinaryProtocolFactory

    class TCyBufferedTransportTestCase(ChunkedTransportTestCase):
        TRANSPORT_FACTORY = TCyChunkedTransportFactory()
